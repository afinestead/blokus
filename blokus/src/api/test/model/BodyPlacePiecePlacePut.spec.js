...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlokusApi.BodyPlacePiecePlacePut();
  });
  ...
  describe('BodyPlacePiecePlacePut', function() {
    it('should create an instance of BodyPlacePiecePlacePut', function() {
      // uncomment below and update the code to test BodyPlacePiecePlacePut
